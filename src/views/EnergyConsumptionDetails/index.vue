<template>
  <div class="parentAdmin">
    ...
    >
      ...
      <div class="submit">
        <van-button type="info" @click.prevent="close" class="ClosePop"
          >退出</van-button
        >
        <van-button type="primary" @click.prevent="SearchClass" class="AddClass"
          >搜索</van-button
        >
      </div>
    </van-popup>
          ...
          <van-cell v-for="item in list" :key="item.Id">
            <van-swipe-cell style="border: 2px solid #ccc;">
              ...
              <van-cell
                ...
                style="padding-left:30px; padding-right: 30px;"
              >
                {{ item.YuSuanShuLiang - item.ShiYongShuLiang }}
                {{ item.JiLiangDanWei }}
              </van-cell>
              <van-cell
                :border="false"
          ...
          <form action="/" method="POST" ref="AddListForm" :model="AddListForm">
            <van-cell-group>
              ...
              <div>
                ...
                <van-field
                  v-model="AddListForm.YuSuanShuLiang"
                  placeholder="请输入预算"
                  style="display:inline-block;"
                />
              </div>
        ...
        <van-popup v-model="ModifyListshow" style="width: 80%;">
          <form action="/" method="POST" ref="AddListForm" :model="dqList">
            <van-cell-group>
              ...
              <div>
                <span class="ListSpan">能耗项目ID:</span>
                <van-field
                  v-model="dqList.NengHaoXiangMuId"
                  placeholder="请输入能耗项目ID"
                  style="display:inline-block;"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <van-field
                  v-model="dqList.ShiYongShuLiang"
                  placeholder="请输入预算"
                  style="display:inline-block;"
                />
              </div>
              <div>
                ...
                <van-field
                  v-model="dqList.YinHangZhangHuIdName"
                  placeholder="请输入银行账户"
                  style="display:inline-block;"
                />
              </div>
              <div>
                <span class="ListSpan">银行账户ID:</span>
                <van-field
                  v-model="dqList.YinHangZhangHuId"
                  placeholder="请输入银行账户"
                  style="display:inline-block;"
                />
              </div>
