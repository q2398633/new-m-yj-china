  ...
  <div class="parentAdmin">
    ...
    <van-popup v-model="show"
      ...
      <form action="/"
            ...
            :model="Search">
        <van-cell-group>
          <div style="font-size: 30px; width: 96.2%; height: 53px; line-height: 53px; color: white; font-family: '楷体'; background: #0199ff; padding-left:15px;">搜索员工培训</div>
          <van-field label="员工:"
                     label-width="110px"
                     autosize
    ...
    <div class="Parent-List">
      <van-pull-refresh v-model="isLoading"
        ...
        <van-button type="info"
                    ...
                    @click.prevent="AddList">添加员工培训项目</van-button>
        <!-- 添加员工培训列表 -->
        <van-popup v-model="AddListshow"
          ...
          <form action="/"
            ...
            <van-cell-group>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">员工:</span>
              ...
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">培训名称:</span>
                <van-field v-model="AddListForm.Title"
                           placeholder="请输入培训名称"
                           style="display:inline-block; width: 55%;" />
              </div>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">起始日期:</span>
              ...
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">结束日期:</span>
              ...
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">教师费用:</span>
                <van-field v-model="AddListForm.JiaoShiFeiYong"
                           placeholder="请输入教师费用"
                           style="display:inline-block; width: 49%;" />
              </div>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">园所费用:</span>
                <van-field v-model="AddListForm.YuanSuoFeiYong"
                           placeholder="请输入园所费用"
                           style="display:inline-block; width: 55%;" />
              </div>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">讲师:</span>
                <van-field v-model="AddListForm.JiangShi"
                           placeholder="请输入讲师"
              ...
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">培训内容:</span>
                <van-field v-model="AddListForm.NeiRong"
                           placeholder="请输入培训内容"
                           style="display:inline-block; width: 55%;" />
              </div>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: .5rem; margin-right: 10px; font-weight: 700; font-family: '楷体';">成果:</span>
                <van-field v-model="AddListForm.ChengGuo"
                           placeholder="请输入成果"
                           style="display:inline-block; width: 55%;" />
              </div>
...
<script>
import { StaffTraining } from '@/api/StaffTraining'
...
export default {
  ...
  methods: {
    ...
    async loadStaffTrainingList () {
      let channels = []
      const data = await StaffTraining()
