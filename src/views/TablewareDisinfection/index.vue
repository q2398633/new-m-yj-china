<template>
  <div class="parentAdmin">
    ...
    <van-popup v-model="show"
               ...
               close-icon="close">
      <van-cell-group>
        <div style="font-size: 30px; width: 96.2%; height: 53px; line-height: 53px; color: white; font-family: '楷体'; background: #0199ff; padding-left:15px;">搜索餐具消毒</div>
        <van-field label="负责人:"
                   label-width="70px"
                   autosize
                   placeholder="请输入负责人" />
    ...
    <div class="Parent-List">
      <van-pull-refresh v-model="isLoading"
        ...
        <van-button type="info"
                    ...
                    @click.prevent="AddList">添加餐具消毒</van-button>
        <!-- 添加餐具消毒 -->
        <van-popup v-model="AddListshow"
          ...
          <form action="/"
            ...
            <van-cell-group>
              <div>
                <span style="font-size: .39rem; color: black; margin-left: 47px; margin-right: 10px; font-weight: 700; font-family: '楷体';">餐别:</span>
...
import { DelectList9 } from '@/api/Delect'
