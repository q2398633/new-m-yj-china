<template>
  <div class="parentAdmin">
    ...
    <van-nav-bar
      ...
      fixed
    >
      <van-icon name="search" slot="right" size="25px" />
    </van-nav-bar>
        ...
        <van-popup v-model="AddListshow" style="width: 80%;">
          <form action="/" method="POST" ref="AddListForm" :model="AddListForm">
            <van-cell-group>
              <div>
                <span
                  style="font-size: .39rem; color: black; margin-left: 47px; margin-right: 10px; font-weight: 700; font-family: '楷体';"
                  >疫苗名称:</span
                >
                <van-field
